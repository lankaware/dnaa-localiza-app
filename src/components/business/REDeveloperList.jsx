...
const REDeveloperList = (props) => {
  const columns = [
    {
      name: 'Nome da Incorporadora',
      selector: row => row.name,
      sortable: true,
      width: '30vw',
      cell: row => (<Link to={"/redeveloper/" + row._id}>{row.name}</Link>)
    },
...
export default REDeveloperList;
